...
internal class RootComponentFactory(
    ...
    override fun createComponent(
        ...
        return when (configuration) {
            is RootComponentImpl.Screen.HeroesList -> heroesListComponentBuilder.buildComponent(componentContext)
            is RootComponentImpl.Screen.Hero -> heroComponentBuilder.buildComponent(
                componentContext = componentContext,
